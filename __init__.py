...
# code is the installed PEP 420 namespace package tap_plugin.administrivia (tap_plugin/administrivia/).
# This exists only so pytest names this project dir's tests fully-qualified as
# plugins.administrivia.tests.* during the monorepo transition, avoiding the orphan-tests
